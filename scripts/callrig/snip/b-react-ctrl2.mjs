export default async ({page}) => {
  ...
  await page.click(sel); await page.keyboard.type('QA-B-R2 reaction toggle',{delay:15});
  ...
  let removedClick=null, afterRemove=null;
  if(test1.pos){ await page.mouse.click(test1.pos.x, test1.pos.y); removedClick=test1.pos;
                 await page.waitForTimeout(3500); afterRemove = await api(); }
  ...
  return {mid, control, added, test1, removedClick, afterRemove, dom};
};
