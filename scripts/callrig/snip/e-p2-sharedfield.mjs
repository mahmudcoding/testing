...
export default async ({page}) => {
  ...
  return await page.evaluate(`(async () => {
    ...
    return {filename:f.filename, owner:JSON.stringify(f.owner).slice(0,120),
            shared_with:JSON.stringify(f.shared_with).slice(0,200),
            context_id:f.context_id, is_favorite:f.is_favorite}; })()`);
};
